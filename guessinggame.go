...
func main() {
	...
	var guess int
	var guessRounds int
	var rangeCeiling int = 10

	// Print some basic information on the screen for the user
	fmt.Println("Game: Guess a number")
	fmt.Println("Please enter the number of rounds")
	fmt.Scan(&guessRounds)
	if guessRounds > 5 {
		rangeCeiling = 100
	}
	fmt.Println("You have", guessRounds, "tries. The number is between 1 and", rangeCeiling, ".")
